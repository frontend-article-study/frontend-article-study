...
### Component 기반 UI 라이브러리 (기능 0 스타일 0)
#### 예시
Material UI, Ant Design
#### 장점 
1. 바로 사용할 수 있는 마크업과 스타일이 존재 설정이 거의 필요 없음
#### 단점
1. 마크업을 자유롭게 할 수 없고 스타일은 대부분 라이브러리에 있는 테마 기반으로만 변경할 수 있어 한정적임
2. 큰 번들 사이즈
   
### Headless UI 라이브러리 (기능 0 스타일 x )
#### 예시 
Headless UI, Radix UI, Reach UI
#### 장점
